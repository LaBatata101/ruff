...
use ruff_linter_commons::cformat::CFormatSummary;
...
use ruff_linter_commons::format::FormatSummary;
...
/// F502
pub fn percent_format_expected_mapping(
...
/// F503
pub fn percent_format_expected_sequence(
    checker: &CheckerSnapshot,
    summary: &CFormatSummary,
    right: &Expr,
    location: TextRange,
...
/// F504
pub fn percent_format_extra_named_arguments(
    checker: &CheckerSnapshot,
    summary: &CFormatSummary,
    right: &Expr,
    location: TextRange,
...
/// F505
pub fn percent_format_missing_arguments(
    checker: &CheckerSnapshot,
    summary: &CFormatSummary,
    right: &Expr,
    location: TextRange,
...
/// F506
pub fn percent_format_mixed_positional_and_named(
    checker: &CheckerSnapshot,
    summary: &CFormatSummary,
    location: TextRange,
) {
...
/// F507
pub fn percent_format_positional_count_mismatch(
    checker: &CheckerSnapshot,
    summary: &CFormatSummary,
    right: &Expr,
    location: TextRange,
...
/// F508
pub fn percent_format_star_requires_sequence(
    checker: &CheckerSnapshot,
    summary: &CFormatSummary,
    right: &Expr,
    location: TextRange,
...
/// F525
pub fn string_dot_format_mixing_automatic(
    checker: &CheckerSnapshot,
    call: &ast::ExprCall,
    summary: &FormatSummary,
) {
