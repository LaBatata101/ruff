...
use ruff_linter_fix::edits::delete_stmt;
...
fn remove_unused_variable(binding: &Binding, checker: &CheckerSnapshot) -> Option<Fix> {
...
/// F841
pub fn unused_variable(checker: &CheckerSnapshot, name: &str, binding: &Binding) {
