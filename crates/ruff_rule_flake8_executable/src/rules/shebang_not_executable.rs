...
/// EXE001
#[cfg(target_family = "unix")]
pub fn shebang_not_executable(filepath: &Path, range: TextRange) -> Option<Diagnostic> {
...
pub fn shebang_not_executable(_filepath: &Path, _range: TextRange) -> Option<Diagnostic> {
    None
}
