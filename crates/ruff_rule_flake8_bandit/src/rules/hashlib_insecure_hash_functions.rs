...
/// S324
pub fn hashlib_insecure_hash_functions(checker: &CheckerSnapshot, call: &ast::ExprCall) {
    if !checker
        .semantic()
...
fn detect_insecure_crypt_calls(checker: &CheckerSnapshot, call: &ast::ExprCall) {
