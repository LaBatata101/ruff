...
use ruff_linter_settings::preview::is_suspicious_function_reference_enabled;
...
pub fn suspicious_function_call(checker: &CheckerSnapshot, call: &ExprCall) {
    suspicious_function(
        checker,
        call.func.as_ref(),
        Some(&call.arguments),
...
pub fn suspicious_function_reference(checker: &CheckerSnapshot, func: &Expr) {
...
/// S308
pub fn suspicious_function_decorator(checker: &CheckerSnapshot, decorator: &Decorator) {
