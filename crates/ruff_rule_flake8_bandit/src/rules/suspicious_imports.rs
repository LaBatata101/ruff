...
pub fn suspicious_imports(checker: &CheckerSnapshot, stmt: &Stmt) {
    // Skip stub files.
...
fn check_and_push_diagnostic<T: Violation>(checker: &CheckerSnapshot, diagnostic: T, range: TextRange) {
