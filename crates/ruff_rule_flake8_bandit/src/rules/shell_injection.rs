...
use ruff_linter_settings::preview::is_shell_injection_only_trusted_input_enabled;
...
use crate::helpers::string_literal;
...
pub fn shell_injection(checker: &CheckerSnapshot, call: &ast::ExprCall) {
