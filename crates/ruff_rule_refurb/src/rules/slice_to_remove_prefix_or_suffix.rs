...
/// FURB188
pub fn slice_to_remove_affix_expr(checker: &CheckerSnapshot, if_expr: &ast::ExprIf) {
...
/// FURB188
pub fn slice_to_remove_affix_stmt(checker: &CheckerSnapshot, if_stmt: &ast::StmtIf) {
    if checker.target_version() < PythonVersion::PY39 {
        return;
    }
