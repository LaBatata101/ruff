...
/// FURB122
pub fn for_loop_writes_binding(checker: &CheckerSnapshot, binding: &Binding) -> Option<Diagnostic> {
...
/// FURB122
pub fn for_loop_writes_stmt(checker: &CheckerSnapshot, for_stmt: &StmtFor) {
