...
/// FURB140
pub fn reimplemented_starmap(checker: &CheckerSnapshot, target: &StarmapCandidate) {
...
impl StarmapCandidate<'_> {
    ...
    pub fn generators(&self) -> &[ast::Comprehension] {
        match self {
