...
/// FURB163
pub fn redundant_log_base(checker: &CheckerSnapshot, call: &ast::ExprCall) {
...
fn generate_fix(checker: &CheckerSnapshot, call: &ast::ExprCall, base: Base, arg: &Expr) -> Result<Fix> {
