...
/// FURB156
pub fn hardcoded_string_charset_literal(checker: &CheckerSnapshot, expr: &ExprStringLiteral) {
...
fn push_diagnostic(checker: &CheckerSnapshot, range: TextRange, charset: &NamedCharset) {
