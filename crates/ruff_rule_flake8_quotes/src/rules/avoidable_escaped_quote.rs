use crate::helpers::{contains_escaped_quote, raw_contents, unescape_string};
use ruff_linter_settings::rules::flake8_quotes::{Quote, Settings};
...
/// Q003
pub fn avoidable_escaped_quote(checker: &CheckerSnapshot, string_like: StringLike) {
