...
/// Q002
fn docstring(checker: &CheckerSnapshot, range: TextRange) {
...
/// Q000, Q001
fn strings(checker: &CheckerSnapshot, sequence: &[TextRange]) {
    let quotes_settings = &checker.settings.flake8_quotes;
    let locator = checker.locator();
...
pub fn check_string_quotes(checker: &CheckerSnapshot, string_like: StringLike) {
