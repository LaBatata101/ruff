...
/// SIM118
fn key_in_dict(checker: &CheckerSnapshot, left: &Expr, right: &Expr, operator: CmpOp, parent: AnyNodeRef) {
...
pub fn key_in_dict_for(checker: &CheckerSnapshot, for_stmt: &ast::StmtFor) {
    key_in_dict(
        checker,
        &for_stmt.target,
        &for_stmt.iter,
...
pub fn key_in_dict_comprehension(checker: &CheckerSnapshot, comprehension: &Comprehension) {
    key_in_dict(
        checker,
...
pub fn key_in_dict_compare(checker: &CheckerSnapshot, compare: &ast::ExprCompare) {
