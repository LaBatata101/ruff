...
/// SIM112
pub fn use_capital_environment_variables(checker: &CheckerSnapshot, expr: &Expr) {
...
fn check_os_environ_subscript(checker: &CheckerSnapshot, expr: &Expr) {
...
/// SIM910
pub fn dict_get_with_none_default(checker: &CheckerSnapshot, expr: &Expr) {
    let Expr::Call(ast::ExprCall {
        func,
