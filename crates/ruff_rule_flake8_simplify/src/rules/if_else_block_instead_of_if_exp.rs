...
use ruff_linter_settings::preview::is_simplify_ternary_to_binary_enabled;
...
/// SIM108
pub fn if_else_block_instead_of_if_exp(checker: &CheckerSnapshot, stmt_if: &ast::StmtIf) {
    let ast::StmtIf {
        test,
        body,
        elif_else_clauses,
