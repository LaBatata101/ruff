...
/// PLR0202
pub fn no_classmethod_decorator(checker: &CheckerSnapshot, stmt: &Stmt) {
    get_undecorated_methods(checker, stmt, &MethodType::Classmethod);
}

/// PLR0203
pub fn no_staticmethod_decorator(checker: &CheckerSnapshot, stmt: &Stmt) {
    get_undecorated_methods(checker, stmt, &MethodType::Staticmethod);
}

fn get_undecorated_methods(checker: &CheckerSnapshot, class_stmt: &Stmt, method_type: &MethodType) {
