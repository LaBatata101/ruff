...
/// PLW1510
pub fn subprocess_run_without_check(checker: &CheckerSnapshot, call: &ast::ExprCall) {
    ...
    if checker
        ...
        .is_some_and(|qualified_name| matches!(qualified_name.segments(), ["subprocess", "run"])) && call.arguments.find_keyword("check").is_none() {
