...
use ruff_linter_commons::matchers::NameMatchPolicy;
use ruff_macros::{derive_message_formats, ViolationMetadata};
use ruff_python_ast::Stmt;
use ruff_text_size::Ranged;

use ruff_codes::Rule;
use ruff_linter_checkers::{ast::CheckerSnapshot, banned_import_policies::BannedModuleImportPolicies};
...
/// C0415
pub fn import_outside_top_level(checker: &CheckerSnapshot, stmt: &Stmt) {
...
fn is_banned_module_level_import(policy: &NameMatchPolicy, checker: &CheckerSnapshot) -> bool {
    policy
        .find(
            checker
                .settings
