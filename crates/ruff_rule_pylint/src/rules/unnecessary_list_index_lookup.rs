...
use crate::helpers::SequenceIndexVisitor;
...
/// PLR1736
pub fn unnecessary_list_index_lookup(checker: &CheckerSnapshot, stmt_for: &StmtFor) {
...
/// PLR1736
pub fn unnecessary_list_index_lookup_comprehension(checker: &CheckerSnapshot, expr: &Expr) {
