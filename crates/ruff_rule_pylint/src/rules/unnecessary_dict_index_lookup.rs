...
/// PLR1733
pub fn unnecessary_dict_index_lookup(checker: &CheckerSnapshot, stmt_for: &StmtFor) {
...
/// PLR1733
pub fn unnecessary_dict_index_lookup_comprehension(checker: &CheckerSnapshot, expr: &Expr) {
