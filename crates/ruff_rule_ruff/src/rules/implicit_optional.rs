...
use ruff_linter_checkers::typing::type_hint_explicitly_allows_none;
...
fn generate_fix(checker: &CheckerSnapshot, conversion_type: ConversionType, expr: &Expr) -> Result<Fix> {
...
/// RUF013
pub fn implicit_optional(checker: &CheckerSnapshot, parameters: &Parameters) {
