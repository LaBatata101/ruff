...
use ruff_linter_noqa::{Codes, Directive, FileNoqaDirectives, NoqaDirectives};
...
pub fn redirected_noqa(diagnostics: &mut Vec<Diagnostic>, noqa_directives: &NoqaDirectives) {
