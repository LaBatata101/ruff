...
/// RUF017
pub fn quadratic_list_summation(checker: &CheckerSnapshot, call: &ast::ExprCall) {
    let ast::ExprCall {
        func,
        arguments,
        range,
...
fn convert_to_reduce(iterable: &Expr, call: &ast::ExprCall, checker: &CheckerSnapshot) -> Result<Fix> {
