...
use ruff_linter_settings::preview::is_support_slices_in_literal_concatenation_enabled;
...
/// RUF005
pub fn collection_literal_concatenation(checker: &CheckerSnapshot, expr: &Expr) {
