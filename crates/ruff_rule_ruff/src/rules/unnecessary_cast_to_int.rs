...
/// RUF046
pub fn unnecessary_cast_to_int(checker: &CheckerSnapshot, call: &ExprCall) {
...
/// and `None` otherwise.
fn call_applicability(checker: &CheckerSnapshot, inner_call: &ExprCall) -> Option<Applicability> {
