...
use ruff_linter_settings::preview::is_unicode_to_unicode_confusables_enabled;
use ruff_codes::AsRule;
use crate::rules::confusables::confusable;
...
/// RUF003
pub fn ambiguous_unicode_character_comment(
...
/// RUF001, RUF002
pub fn ambiguous_unicode_character_string(checker: &CheckerSnapshot, string_like: StringLike) {
