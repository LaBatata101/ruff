...
pub fn assert_with_print_message(checker: &CheckerSnapshot, stmt: &ast::StmtAssert) {
...
mod print_arguments {
    ...
    pub(super) fn to_expr(arguments: &Arguments, checker: &CheckerSnapshot) -> Option<Expr> {
