...
fn check_mark_parentheses(checker: &CheckerSnapshot, decorator: &Decorator, marker: &str) {
...
fn check_useless_usefixtures(checker: &CheckerSnapshot, decorator: &Decorator, marker: &str) {
...
pub fn marks(checker: &CheckerSnapshot, decorators: &[Decorator]) {
