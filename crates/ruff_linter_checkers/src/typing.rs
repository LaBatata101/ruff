...
impl<'a> TypingTarget<'a> {
    ...
    pub fn contains_none(&self, checker: &CheckerSnapshot, version: ast::PythonVersion) -> bool {
        match self {
            TypingTarget::None
    ...
    pub fn contains_any(&self, checker: &CheckerSnapshot, version: ast::PythonVersion) -> bool {
        match self {
...
pub fn type_hint_explicitly_allows_none<'a>(
    annotation: &'a Expr,
    checker: &'a CheckerSnapshot,
    version: ast::PythonVersion,
) -> Option<&'a Expr> {
...
///
/// This function assumes that the annotation is a valid typing annotation expression.
pub fn type_hint_resolves_to_any(
    annotation: &Expr,
