...
use crate::helpers::normalize_word;
use ruff_linter_settings::rules::pydocstyle::Settings;
...
/// D401
pub fn non_imperative_mood(checker: &CheckerSnapshot, docstring: &Docstring, settings: &Settings) {
