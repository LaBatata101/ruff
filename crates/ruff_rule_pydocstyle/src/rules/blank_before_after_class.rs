...
/// D203, D204, D211
pub fn blank_before_after_class(checker: &CheckerSnapshot, docstring: &Docstring) {
        ...
        || checker.enabled(Rule::BlankLineBeforeClass)
    {
        ...
        if checker.enabled(Rule::BlankLineBeforeClass) && blank_lines_before != 0 {
        ...
        if checker.enabled(Rule::IncorrectBlankLineBeforeClass) && blank_lines_before != 1 {
            let mut diagnostic =
