...
use ruff_linter_commons::docstrings::sections::SectionKind;
use ruff_linter_commons::docstrings::Docstring;

use crate::helpers::logical_line;
...
/// D415
pub fn ends_with_punctuation(checker: &CheckerSnapshot, docstring: &Docstring) {
