...
use ruff_linter_commons::helpers::is_fastapi_route;
...
/// FAST002
pub fn fastapi_non_annotated_dependency(
...
fn is_fastapi_dependency(checker: &CheckerSnapshot, expr: &ast::Expr) -> Option<FastApiDependency> {
    checker
        .semantic()
