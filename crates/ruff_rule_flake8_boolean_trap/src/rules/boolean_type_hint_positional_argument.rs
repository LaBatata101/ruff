...
use ruff_linter_settings::preview::is_bool_subtype_of_annotation_enabled;
use crate::helpers::is_allowed_func_def;
...
/// FBT001
pub fn boolean_type_hint_positional_argument(
    ...
    for parameter in parameters.posonlyargs.iter().chain(&parameters.args) {
        ...
        } else if !match_annotation_to_literal_bool(annotation) {
            continue;
        }
