...
use regex::Regex;
use ruff_codes::codes::{self, RuleCodePrefix};
use rustc_hash::FxHashSet;
use std::fmt::{Display, Formatter};
use std::path::{Path, PathBuf};
use std::sync::LazyLock;

use ruff_codes::{self, Linter};
use ruff_macros::CacheKey;
use ruff_python_ast::PythonVersion;

use ruff_codes::types::{CompiledPerFileIgnoreList, ExtensionMapping, FilePatternSet, CompiledPerFileTargetVersionList};
...
pub struct LinterSettings {
    ...
    // Plugins
    pub flake8_annotations: flake8_annotations::Settings,
    pub flake8_bandit: flake8_bandit::Settings,
    pub flake8_boolean_trap: flake8_boolean_trap::Settings,
    pub flake8_bugbear: flake8_bugbear::Settings,
    pub flake8_builtins: flake8_builtins::Settings,
    pub flake8_comprehensions: flake8_comprehensions::Settings,
    pub flake8_copyright: flake8_copyright::Settings,
    pub flake8_errmsg: flake8_errmsg::Settings,
    pub flake8_gettext: flake8_gettext::Settings,
    pub flake8_implicit_str_concat: flake8_implicit_str_concat::Settings,
    pub flake8_import_conventions: flake8_import_conventions::Settings,
    pub flake8_pytest_style: flake8_pytest_style::Settings,
    pub flake8_quotes: flake8_quotes::Settings,
    pub flake8_self: flake8_self::Settings,
    pub flake8_tidy_imports: flake8_tidy_imports::Settings,
    pub flake8_type_checking: flake8_type_checking::Settings,
    pub flake8_unused_arguments: flake8_unused_arguments::Settings,
    pub isort: isort::Settings,
    pub mccabe: mccabe::Settings,
    pub pep8_naming: pep8_naming::Settings,
    pub pycodestyle: pycodestyle::Settings,
    pub pydoclint: pydoclint::Settings,
    pub pydocstyle: pydocstyle::Settings,
    pub pyflakes: pyflakes::Settings,
    pub pylint: pylint::Settings,
    pub pyupgrade: pyupgrade::Settings,
    pub ruff: ruff::Settings,
}
...
impl LinterSettings {
    ...
    pub fn new(project_root: &Path) -> Self {
        Self {
            ...
            typing_modules: vec![],
            flake8_annotations: flake8_annotations::Settings::default(),
            flake8_bandit: flake8_bandit::Settings::default(),
            flake8_boolean_trap: flake8_boolean_trap::Settings::default(),
            flake8_bugbear: flake8_bugbear::Settings::default(),
            flake8_builtins: flake8_builtins::Settings::default(),
            flake8_comprehensions: flake8_comprehensions::Settings::default(),
            flake8_copyright: flake8_copyright::Settings::default(),
            flake8_errmsg: flake8_errmsg::Settings::default(),
            flake8_gettext: flake8_gettext::Settings::default(),
            flake8_implicit_str_concat: flake8_implicit_str_concat::Settings::default(),
            flake8_import_conventions: flake8_import_conventions::Settings::default(),
            flake8_pytest_style: flake8_pytest_style::Settings::default(),
            flake8_quotes: flake8_quotes::Settings::default(),
            flake8_self: flake8_self::Settings::default(),
            flake8_tidy_imports: flake8_tidy_imports::Settings::default(),
            flake8_type_checking: flake8_type_checking::Settings::default(),
            flake8_unused_arguments: flake8_unused_arguments::Settings::default(),
            isort: isort::Settings::default(),
            mccabe: mccabe::Settings::default(),
            pep8_naming: pep8_naming::Settings::default(),
            pycodestyle: pycodestyle::Settings::default(),
            pydoclint: pydoclint::Settings::default(),
            pydocstyle: pydocstyle::Settings::default(),
            pyflakes: pyflakes::Settings::default(),
            pylint: pylint::Settings::default(),
            pyupgrade: pyupgrade::Settings::default(),
            ruff: ruff::Settings::default(),
