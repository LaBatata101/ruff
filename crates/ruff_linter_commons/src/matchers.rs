...
#[derive(Debug)]
pub struct MatchNameOrParent<'a> {
    pub module: &'a str,
}
...
impl NameMatchPolicy<'_> {
    pub fn find<'a>(&self, banned_modules: impl Iterator<Item = &'a str>) -> Option<String> {
