...
/// PYI036
pub fn bad_exit_annotation(checker: &CheckerSnapshot, function: &StmtFunctionDef) {
    let StmtFunctionDef {
        is_async,
        decorator_list,
        name,
...
fn check_short_args_list(checker: &CheckerSnapshot, parameters: &Parameters, func_kind: FuncKind) {
