...
use ruff_linter_fix::edits::{add_argument, remove_argument, Parentheses};
...
/// PYI059
pub fn generic_not_last_base_class(checker: &CheckerSnapshot, class_def: &ast::StmtClassDef) {
