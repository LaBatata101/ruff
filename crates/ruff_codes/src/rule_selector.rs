...
use crate::{Linter, Rule, RuleNamespace};
...
// FIX: remove comment
            RuleSelector::C =>RuleSelectorIter::All(Rule::iter()), // RuleSelectorIter::Chain(
                // Linter::Flake8Comprehensions
                //     .rules()
                //     .chain(Linter::McCabe.rules()),
            //),
             // FIX: remove comment
            RuleSelector::T =>  RuleSelectorIter::All(Rule::iter()), //RuleSelectorIter::Chain(
...
mod schema {
    ...
    use crate::rule_selector::{Linter, RuleCodePrefix, RuleSelector};
...
pub mod clap_completion {
    ...
    use crate::{
        ...
        rule_selector::{is_single_rule_selector, RuleSelector},
    };
