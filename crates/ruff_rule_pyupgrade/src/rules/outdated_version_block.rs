...
use ruff_linter_fix::edits::{adjust_indentation, delete_stmt};
...
/// UP036
pub fn outdated_version_block(checker: &CheckerSnapshot, stmt_if: &StmtIf) {
    ...
    match if_major.cmp(&py_major) {
        ...
        Ordering::Equal => {
            ...
            Ok(if or_equal {
                ...
                if_minor < py_minor
            } else if let Some(if_micro) = if_micro {
