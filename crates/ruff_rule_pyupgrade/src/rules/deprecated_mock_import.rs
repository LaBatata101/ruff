...
use ruff_linter_fix::cst::matchers::{match_import, match_import_from, match_statement};
...
/// UP026
pub fn deprecated_mock_attribute(checker: &CheckerSnapshot, attribute: &ast::ExprAttribute) {
...
/// UP026
pub fn deprecated_mock_import(checker: &CheckerSnapshot, stmt: &Stmt) {
    match stmt {
