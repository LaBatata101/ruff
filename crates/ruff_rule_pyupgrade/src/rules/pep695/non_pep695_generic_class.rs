...
use ruff_linter_commons::helpers::{find_generic, DisplayTypeVars};
...
use super::{
    check_type_vars,in_nested_context, TypeVarReferenceVisitor,
};
...
/// UP046
pub fn non_pep695_generic_class(checker: &CheckerSnapshot, class_def: &StmtClassDef) {
