...
use ruff_linter_checkers::{ast::CheckerSnapshot, shadowed::ShadowedKind};
use ruff_linter_commons::renamer::Renamer;
...
/// UP049
pub fn private_type_parameter(checker: &CheckerSnapshot, binding: &Binding) -> Option<Diagnostic> {
    ...
    diagnostic.try_set_fix(|| {
        ...
        let fix_isolation = CheckerSnapshot::isolation(binding.source);
