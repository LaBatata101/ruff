...
use super::{check_type_vars, in_nested_context, TypeVarReferenceVisitor};
...
pub struct NonPEP695GenericFunction {
    name: String,
}
...
/// UP047
pub fn non_pep695_generic_function(checker: &CheckerSnapshot, function_def: &StmtFunctionDef) {
