...
use ruff_linter_settings::rules::flake8_type_checking::Settings;
...
pub fn is_typing_reference(reference: &ResolvedReference, settings: &Settings) -> bool {
...
pub fn is_valid_runtime_import(
    binding: &Binding,
...
pub fn runtime_required_function(
...
pub fn is_dataclass_meta_annotation(annotation: &Expr, semantic: &SemanticModel) -> bool {
...
///     ...
/// ```
pub fn is_singledispatch_interface(
    function_def: &ast::StmtFunctionDef,
    semantic: &SemanticModel,
) -> bool {
...
///     ...
/// ```
pub fn is_singledispatch_implementation(
    function_def: &ast::StmtFunctionDef,
    semantic: &SemanticModel,
) -> bool {
    function_def.decorator_list.iter().any(|decorator| {
...
pub fn filter_contained(edits: Vec<Edit>) -> Vec<Edit> {
    let mut edits = edits;
