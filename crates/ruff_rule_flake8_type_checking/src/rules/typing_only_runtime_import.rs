...
use ruff_linter_settings::preview::is_full_path_match_source_strategy_enabled;
use crate::helpers::{
    filter_contained, is_typing_reference, quote_annotation,
};
use crate::imports::ImportBinding;
use ruff_codes::rules::isort::categorize::MatchSourceStrategy;
use ruff_codes::rules::isort::{categorize, ImportSection, ImportType};
...
fn fix_imports(checker: &CheckerSnapshot, node_id: NodeId, imports: &[ImportBinding]) -> Result<Fix> {
    ...
    .isolate(CheckerSnapshot::isolation(
