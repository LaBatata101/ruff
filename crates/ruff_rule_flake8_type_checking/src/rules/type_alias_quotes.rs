...
use ruff_codes::Rule;
use crate::helpers::quote_type_expression;
...
/// TC007
pub fn unquoted_type_alias(checker: &CheckerSnapshot, binding: &Binding) -> Option<Vec<Diagnostic>> {
