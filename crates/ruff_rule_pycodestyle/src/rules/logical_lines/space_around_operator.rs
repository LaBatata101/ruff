...
/// E221, E222, E223, E224
pub fn space_around_operator(line: &LogicalLine, context: &mut LogicalLinesContext) {
...
/// E241, E242
pub fn space_after_comma(line: &LogicalLine, context: &mut LogicalLinesContext) {
    for token in line.tokens() {
