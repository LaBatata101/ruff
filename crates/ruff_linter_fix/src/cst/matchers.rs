use crate::codemods::CodegenStylist;
...
pub fn match_statement(statement_text: &str) -> Result<Statement> {
...
pub fn match_import<'a, 'b>(statement: &'a mut Statement<'b>) -> Result<&'a mut Import<'b>> {
...
pub fn match_call<'a, 'b>(expression: &'a Expression<'b>) -> Result<&'a Call<'b>> {
...
pub fn match_name<'a, 'b>(expression: &'a Expression<'b>) -> Result<&'a Name<'b>> {
...
pub fn match_arg<'a, 'b>(call: &'a Call<'b>) -> Result<&'a Arg<'b>> {
...
pub fn match_generator_exp<'a, 'b>(
...
pub fn match_tuple<'a, 'b>(expression: &'a Expression<'b>) -> Result<&'a Tuple<'b>> {
...
pub fn match_list_comp<'a, 'b>(expression: &'a Expression<'b>) -> Result<&'a ListComp<'b>> {
...
pub fn match_lambda<'a, 'b>(expression: &'a Expression<'b>) -> Result<&'a Lambda<'b>> {
...
pub fn match_formatted_string<'a, 'b>(
    expression: &'a mut Expression<'b>,
...
pub fn match_formatted_string_expression<'a, 'b>(
...
pub fn match_indented_block<'a, 'b>(
    suite: &'a mut Suite<'b>,
...
pub fn match_with<'a, 'b>(statement: &'a mut Statement<'b>) -> Result<&'a mut With<'b>> {
    if let Statement::Compound(compound) = statement {
...
pub fn match_if<'a, 'b>(statement: &'a mut Statement<'b>) -> Result<&'a mut If<'b>> {
    if let Statement::Compound(compound) = statement {
...
pub fn transform_expression_text(
    source_code: &str,
