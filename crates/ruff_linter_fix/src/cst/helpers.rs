...
pub fn space() -> ParenthesizableWhitespace<'static> {
...
pub fn or_space(whitespace: ParenthesizableWhitespace) -> ParenthesizableWhitespace {
...
pub fn negate<'a>(expression: &Expression<'a>) -> Expression<'a> {
