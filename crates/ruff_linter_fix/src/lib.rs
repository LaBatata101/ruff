...
use ruff_linter_message::{linter::LinterResult, DiagnosticMessage, Message};
...
mod tests {
    ...
    use crate::{apply_fixes, FixResult};
    use ruff_linter_message::DiagnosticMessage;
    // FIX: remove comment
    //use ruff_codes::pycodestyle::rules::MissingNewlineAtEndOfFile;
    use ruff_codes::rules::isort::UnsortedImports;
    ...
    fn create_diagnostics(
        ...
        edit.into_iter()
            .map(|edit| {
                ...
                let diagnostic = Diagnostic::new(UnsortedImports, range);
                DiagnosticMessage {
