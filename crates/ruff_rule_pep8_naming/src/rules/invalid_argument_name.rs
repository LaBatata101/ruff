...
/// N803
pub fn invalid_argument_name_function(checker: &CheckerSnapshot, function_def: &StmtFunctionDef) {
...
/// N803
pub fn invalid_argument_name_lambda(checker: &CheckerSnapshot, lambda: &ExprLambda) {
...
/// N803
fn invalid_argument_name(checker: &CheckerSnapshot, parameters: &Parameters) {
