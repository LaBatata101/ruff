use ruff_linter_commons::helpers::is_not_implemented_stub_with_variable;
...
fn function(argumentable: Argumentable, parameters: &Parameters, scope: &Scope, checker: &CheckerSnapshot) {
...
fn method(argumentable: Argumentable, parameters: &Parameters, scope: &Scope, checker: &CheckerSnapshot) {
    let ignore_variadic_names = checker
        .settings
        .flake8_unused_arguments
        .ignore_variadic_names;
...
pub fn unused_arguments(checker: &CheckerSnapshot, scope: &Scope) {
