...
use ruff_codes::Rule;
use crate::helpers::auto_return_type;
use ruff_linter_checkers::typing::type_hint_resolves_to_any;
...
fn is_stub_function(function_def: &ast::StmtFunctionDef, checker: &CheckerSnapshot) -> bool {
