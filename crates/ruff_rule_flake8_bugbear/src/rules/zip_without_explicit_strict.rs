...
use ruff_linter_fix::edits::add_argument;
...
/// B905
pub fn zip_without_explicit_strict(checker: &CheckerSnapshot, call: &ast::ExprCall) {
...
pub fn is_infinite_iterable(arg: &Expr, semantic: &SemanticModel) -> bool {
            ...
            match qualified_name.segments() {
                ...
                ["itertools", "repeat"] => {
                    ...
                    for keyword in keywords {
                        if keyword.arg.as_ref().is_some_and(|name| name == "times") && keyword.value.is_none_literal_expr() {
                            return true;
                        }
                    }
