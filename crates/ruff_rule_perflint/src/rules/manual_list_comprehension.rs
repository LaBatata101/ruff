...
use ruff_linter_settings::preview::is_fix_manual_list_comprehension_enabled;
use ruff_linter_checkers::ast::CheckerSnapshot;
use crate::helpers::statement_deletion_range;
use anyhow::{anyhow, Result};
use ruff_diagnostics::{Diagnostic, Edit, Fix, FixAvailability, Violation};

use crate::helpers::comment_strings_in_range;
...
/// PERF401
pub fn manual_list_comprehension(checker: &CheckerSnapshot, for_stmt: &ast::StmtFor) {
    ...
    if !for_stmt.is_async && if_test.is_none() && arg
                .as_name_expr()
