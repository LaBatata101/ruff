...
use crate::helpers::{comment_strings_in_range, statement_deletion_range};
use ruff_linter_checkers::ast::CheckerSnapshot;
use ruff_linter_settings::preview::is_fix_manual_dict_comprehension_enabled;
...
/// PERF403
pub fn manual_dict_comprehension(checker: &CheckerSnapshot, for_stmt: &ast::StmtFor) {
